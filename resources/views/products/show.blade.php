    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="form-inline-row row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="company_name" name="company_name" value="{{ $product->company->company_name }}" readonly>
                </div>
            </div>
            ...
            <div class="form-inline-row row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="price" name="price" value="{{ '¥' . number_format($product->price) }}" readonly>
                </div>
            </div>
            ...
            <div class="form-inline-row row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="comment" name="comment" value="{{ $product->comment }}" readonly>
                </div>
            </div>
